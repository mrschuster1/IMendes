...
uses
  Vcl.Forms,
  Provider.Connection
    in 'src\Providers\Provider.Connection.pas' {ProviderConnection: TDataModule} ,
  ...
  Services.Empresas
    in 'src\Services\Services.Empresas.pas' {ServiceEmpresas: TDataModule} ,
  Services.Produtos
    in 'src\Services\Services.Produtos.pas' {ServiceProdutos: TDataModule} ,
  View.Importacao in 'src\View\View.Importacao.pas' {formImportacao} ,
  Services.Tributos
    in 'src\Services\Services.Tributos.pas' {ServiceTributos: TDataModule} ,
  Model.Produto in 'src\Model\Model.Produto.pas',
  Provider.IMendes.Data
    in 'src\Providers\Provider.Imendes.Data.pas' {ProviderImendesData: TDataModule} ,
  Services.Produtos.IMendes
    in 'src\Services\Services.Produtos.IMendes.pas' {ServiceProdutosIMendes: TDataModule} ,
  View.Integracao in 'src\View\View.Integracao.pas' {formIntegracao};
