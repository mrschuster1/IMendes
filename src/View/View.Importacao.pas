...
procedure TformImportacao.AddLikeCondition(AItemList: TcxFilterCriteriaItemList;
  AColumn: TcxCustomGridTableItem; const ALike: string);
begin
...
procedure TformImportacao.AddLikeFilter;
var
  ALike: string;
...
procedure TformImportacao.btnCancelarClick(Sender: TObject);
begin
  inherited;
  Cancelar
end;
...
procedure TformImportacao.btnProcessarClick(Sender: TObject);
begin
  inherited;
  Processar
end;

procedure TformImportacao.buttonImprimirGradeClick(Sender: TObject);
begin
  inherited;
  Imprimir
end;

procedure TformImportacao.Cancelar;
begin
  MemData.Close
end;

procedure TformImportacao.ClearLikeFilter;
var
  i: Integer;
...
procedure TformImportacao.DataSourceStateChange(Sender: TObject);
begin
  inherited;
...
procedure TformImportacao.edtPesquisaPropertiesChange(Sender: TObject);
begin
  inherited;
  Pesquisar
end;

procedure TformImportacao.FormCreate(Sender: TObject);
begin
  inherited;
  FMarcarTodos := false
end;

procedure TformImportacao.Imprimir;
begin
  GridPrinter.Preview(true)
end;

procedure TformImportacao.Pesquisar;
var
...
procedure TformImportacao.Processar;
begin
  var
...
procedure TformImportacao.TableViewMarcadoHeaderClick(Sender: TObject);
begin
  inherited;
  MemData.DisableControls;
  MemData.First;
...
procedure TformImportacao.TableViewCustomDrawCell(Sender: TcxCustomGridTableView;
  ACanvas: TcxCanvas; AViewInfo: TcxGridTableDataCellViewInfo;
  var ADone: Boolean);
begin
  inherited;
